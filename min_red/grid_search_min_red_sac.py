...
def run(envs, ent_coef, betas, sparsity_levels, learning_rate, learning_starts, methods, n_repeats, buffer_size, wandb_log_interval, total_timesteps, pause, dry):
                ...
                for beta in betas:
                    for sparsity_level in sparsity_levels:
                        cmd_line = f"python -m min_red.train --f min_red/config/mujoco --algorithm_type SAC " \
                                   ...
                                   f" --env_kwargs.sparsity_level {sparsity_level} " \
...
if __name__ == '__main__':
    ...
    parser.add_argument("--sparsity_levels", nargs="+", default=[1])
